...
function handleMessage(message, sender, sendResponse) {
  if (message.action === "setUserNotes") {
    ...
    setUserNotes(jsonText, studentCode, force, changeDisabled, av, autoCloseComment, autoCloseAlumnes)
      .then(resultado => {
...
async function setUserNotes(jsonText, studentCode, force, changeDisabled, av, autoCloseComment, autoCloseAlumnes) {
  ...
  // 3. Application Phase
  applyGrades(elementMap, student.notes, force, changeDisabled, av);
 ...
 */
function applyGrades(elementMap, notes, force, changeDisabled, currentAv) {
